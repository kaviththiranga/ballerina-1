...
public function newInstance(public handle class, int ...dimensions) returns handle = external;
...
public function get(public handle array, public int index) returns handle = external;
...
public function set(public handle array, public int index, public handle element) = external;

# Returns the length of the given Java array.
#
# + array - the `handle` which referes to the Java array
# + return - the length of the given Java array
public function getLength(public handle array) returns int = external;
